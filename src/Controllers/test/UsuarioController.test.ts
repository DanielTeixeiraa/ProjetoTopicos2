...
describe('UsuarioController', () => {
    ...
    describe('criarUsuario', () => {
        ...
        it('deve retornar 500 quando ocorrer algum erro', async () => {
            ...
            expect(res.json).toBeCalledWith({ error: 'Nao foi possivel criar usuario' });
        });
    });
...
describe('obterUsuarios', () => {
    ...
    it('deve retornar 500 quando ocorrer algum erro', async () => {
        ...
        expect(res.status).toBeCalledWith(500);
        expect(res.json).toBeCalledWith({ error: 'Nao foi possivel obter usuarios' });
    }
    );
});
...
describe('obterUsuario', () => {
    ...
    it('deve retornar 404 quando usuario nao for encontrado', async () => {
        ...
        expect(res.json).toBeCalledWith({ error: 'Usuario nao encontrado' });
    }
    );
    ...
    it('deve retornar 500 quando ocorrer algum erro', async () => {
        ...
        expect(res.status).toBeCalledWith(500);
        expect(res.json).toBeCalledWith({ error: 'Nao foi possivel obter usuario' });
    }
    );
});
...
describe('atualizarUsuario', () => {
    ...
    it('deve retornar 500 quando ocorrer algum erro', async () => {
        ...
        expect(res.status).toBeCalledWith(500);
        expect(res.json).toBeCalledWith({ error: 'Nao foi possivel atualizar usuario' });
